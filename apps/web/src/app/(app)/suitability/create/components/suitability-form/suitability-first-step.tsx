...
export default function SuitabilityFirstStep() {
  const { form, onNextStepClick } = useCreateSuitabilityPageContext()
  ...
  return (
    ...
    <div className='flex w-full mt-8 justify-end'>
      <Button type='button' onClick={() => onNextStepClick()}>Próximo passo</Button>
    </div>
